...
@st.cache_data
def load_data():
    return pd.read_csv(r"books_with_clusters.csv")

@st.cache_resource
def load_cosine_sim_model():
    with open(r"C:\Users\LENOVO\Desktop\Audible\models\cosine_similarity_matrix.pkl", "rb") as file:
        return pickle.load(file)


@st.cache_resource
def load_kmeans_model():
    with open(r"C:\Users\LENOVO\Desktop\Audible\models\kmeans_model.pkl", "rb") as file:
        return pickle.load(file)
